...
def run_funsearch_search(
    ...
    candidate_programs = [item["program"] for item in valid_candidates]
    candidate_scores = [float(item["score"]) for item in valid_candidates]
    ...
    if verbosity != "quiet":
        ...
        print(f"[INFO] Candidate programs available before committee selection: {len(candidate_programs)}")
...
def main() -> None:
    ...
    for template_name, specification in template_items:
        ...
        template_candidate_programs = template_artifacts.candidate_programs or template_artifacts.top_k_programs
        template_candidate_scores = template_artifacts.candidate_scores or template_artifacts.top_k_scores
        for rank, (program, score) in enumerate(zip(template_candidate_programs, template_candidate_scores)):
